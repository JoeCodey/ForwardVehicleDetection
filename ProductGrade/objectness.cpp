...
#include "objectness.hpp"
    ...
    int objectness(Mat& cannyEdges, Mat& sobelMagnitude, Rect bound_box, Point offset, Mat& src_original, Mat& pixelDifference){
        ...
        findContours(cannyEdges, contours, hierarchyCannyContours, RETR_LIST,CHAIN_APPROX_NONE ) ;    
        ...
        cvtColor(contoursCanny, contoursCanny,  COLOR_GRAY2BGR) ;
        cvtColor(contoursCannyNoCross, contoursCannyNoCross,  COLOR_GRAY2BGR) ;
